...
namespace Ibsys2.Services
{
    public class StuecklistenService
    {
        ...
        private void GetBenötigteTeile(
            ...
            StuecklistenPosition stuecklistenPosition
        )
        {
            ...
            if (!teile.TryAdd(stuecklistenPosition.Teil, stuecklistenPosition.Anzahl))
                teile[stuecklistenPosition.Teil] += stuecklistenPosition.Anzahl;
