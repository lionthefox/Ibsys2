...
namespace Ibsys2.Services
{
    public class ArbeitsplatzAufloesenService
    {
        ...
        public List<ArbeitsplatzNachfolger> ArbeitsplatzAuflösen(IList<Arbeitsplatz> arbeitsplaetze,
            IList<StuecklistenPosition> stueckliste)
        {
            ...
            foreach (var Arbeitsplatz in arbeitsplaetze)
            {
                ...
                var existingItem =
                    aufloesung.FirstOrDefault(x => x.Platz == Arbeitsplatz.Platz && x.Matnr == Arbeitsplatz.Matnr);
                if (existingItem == null)
                {
                    ...
                    GetBenoetigteTeile(stücklistenAufloesung.BenoetigteTeile, Arbeitsplatz,
                        stücklistenAufloesung.Nachfolger, stueckliste);
        ...
        private void GetBenoetigteTeile(Dictionary<int, int> benoetigteTeile, Arbeitsplatz arbeitsplatz,
            IList<int> nachfolger, IList<StuecklistenPosition> stueckliste)
        {
